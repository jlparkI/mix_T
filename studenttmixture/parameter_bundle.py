...
class ParameterBundle():
    ...
    def __init__(self, X, n_components, start_df, random_state, hyperparams):
        self.loc_, self.scale_inv_, self.scale_inv_chole_, self.df_ = \
                   self.initialize_params(X, n_components, start_df, random_state)
